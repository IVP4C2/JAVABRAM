...
public class MemberAdminUI extends javax.swing.JFrame {
    ...
    private JTextArea textFineMemberInfo;
    ...
    private void setupFrame() {
        ...
        textFineMemberInfo = new JTextArea();
        textFineMemberInfo.setForeground(Color.RED);
        ...
        setSize(300, 350);
        memberInfoPanel.add(textFineMemberInfo);
    }
    ...
    private void doFindMember(int membershipNr) {
      ...
      String currentFine = Double.toString(currentMember.getFine());


        removeMemberButton.setEnabled(memberCanBeRemoved);
        textAreaMemberInfo.setText(memberInfo);
        textFineMemberInfo.setText("Boete: " + currentFine);
